package com.csp.github.starter.exception;
...
public class DefaultGlobalExceptionHandlerAdvice {
    ...
    public Object numberFormatException(NumberFormatException ex) {
        ...
        return Result.fail(ResultType.FORMAT_EXCEPTION.getCode(), ResultType.FORMAT_EXCEPTION.getMsg());
    }
    ...
    public Object constraintViolationException(ConstraintViolationException ex) {
        ...
        return Result.fail(ResultType.PARAM_INVALID.getCode(), msg);
    }
    ...
    public Result validateException(Exception ex) {
        ...
        return Result.fail(ResultType.PARAM_INVALID.getCode(), ResultType.PARAM_INVALID.getMsg());
    }
